...
from src.miscancionesapp.modelo.declarative_base import Session
...
class AlbumTestCase ( unittest.TestCase ) :
    def setUp ( self ) :
        ...
        '''Crea los objetos'''
        self.album1 = Album ( titulo = 'Corazones' , ano = 1990 , descripcion = 'No tiene' , medio = Medio.CD ,
                              canciones = [ ] )
        self.album2 = Album ( titulo = 'La voz de los 80s' , ano = 1984 , descripcion = 'No tiene' ,
                              medio = Medio.CASETE ,
                              canciones = [ ] )
        self.album3 = Album ( titulo = 'Pateando piedras' , ano = 1986 , descripcion = 'No tiene' ,
                              medio = Medio.DISCO ,
                              canciones = [ ] )
        self.album4 = Album ( titulo = 'La cultura de la basura' , ano = 1987 , descripcion = 'No tiene' ,
                              medio = Medio.DISCO ,
                              canciones = [ ] )
    ...
    def test_verificar_almacenamiento_agregar_album ( self ) :
        ...
        self.coleccion.agregar_album ( titulo = "Signos" , anio = 1986 , descripcion = "No tiene" ,
                                       medio = Medio.DISCO )
